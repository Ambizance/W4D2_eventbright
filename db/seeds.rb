...
25.times do
  event = Event.create(title:Faker::Lorem.words(number: 2).join(" "), description:Faker::Lorem.sentences(number: 2).join(" "), admin_id:rand(1..User.count),location:city_list[rand(1..city_list.length)], price:rand(0..100),duration:rand(1..7), start_date:Faker::Date.between(from: '2021-01-01', to: '2021-12-31'))
